...
public class SaleControllerTests {
    ...
    NewSaleDto saleCreateDtoWithWrongPromotion = new NewSaleDto("Такая вот скидка в несуществующей подборке", "200", 10L);
    ...
    void postSaleWithPromotionWhichDoesntExist() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .post("/product/1/sale")
                        .content(mapper.writeValueAsString(saleCreateDtoWithWrongPromotion))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
}
