...
DROP table IF EXISTS model_sets_products_join CASCADE;
...
INSERT INTO categories values (1, 'Телевизеры', 'ROOT', 1);
INSERT INTO categories values (2, 'Коньтютеры', 'ROOT', 2);
INSERT INTO categories values (3, 'Телефоны','ROOT', 3);
INSERT INTO categories values (4, 'Собаки','ROOT', 4);
INSERT INTO categories values (5, 'Кошки','ROOT', 5);
...
CREATE TABLE IF NOT EXISTS model_sets_products_join (
    model_set_id BIGINT REFERENCES model_sets(model_set_id) ON DELETE CASCADE,
    product_id BIGINT REFERENCES products(product_id) ON DELETE CASCADE,
    PRIMARY KEY (model_set_id, product_id)
);
--
--
